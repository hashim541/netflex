...
export default function Login2({setLoginState}){
    const data= [
                'No commitments, Cancel anytime.',
                'Every thing on Netflex for one low price',
                'No adds no extra fees. Ever.'
                ]
    return(
        <div className="form-div2">
            <Ctick />
            <div className="l2top">
            <p className="form-p form-p2">STEP <span className="bold">2</span> OF <span className="bold">3</span></p>
            <h3 className="ltitle ltitle2">Choose your plan</h3>
            </div>
            <div className="cont">
                {data.map(d =>(
                    <Plans key={d} txt={d}/>
            ...
            <button className="sign-in next" onClick={()=>setLoginState(3)}>Next</button>
        </div>
    )
}
function Plans({txt}){
...
function Ctick() {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" width="40px" height="40px" viewBox="0 0 117 117" fill="#000000">
            ...
            <g id="SVGRepo_iconCarrier">
                ...
                <desc></desc>
                <defs></defs>
                <g fill="none" fillRule="evenodd" id="Page-1" strokeWidth="1">
