...
function Logo(){
    return (
        <svg className="logo" viewBox="0 -109.31 300 300" xmlns="http://www.w3.org/2000/svg" fill="#000000"><g id="SVGRepo_bgCarrier" stroke_width="0">
        </g>
        <g id="SVGRepo_tracerCarrier" stroke_linecap="round" stroke_linejoin="round"></g>
